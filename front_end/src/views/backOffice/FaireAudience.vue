...
<script>
    ...
    export default {
      ...
      created(){
        ...
        this.audience.sender = ses.autorite_enfant
      ...
      methods: {
        ...
        async all_actual_events(){
          ...
          const events = await faire_audience(ses.autorite_enfant.id,this.audience.direction)
          return events
        }, 
      ...
      margin-left: 3.7rem; width: 23.4rem;">
            ...
            if (formValues) {
              ...
              const audience = {
                ...
                id_autorite_sender: this.audience.sender.id,
              ...
              // console.log(response)
              if(response.message){
                swal("Audience enregistrée", "Votre audience a bien été ajoutée", "success");
                // setInterval( () => {
                //   window.location.reload()
                // }, 1000)
              }
