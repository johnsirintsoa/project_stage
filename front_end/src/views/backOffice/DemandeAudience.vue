    ...
    export default {
      ...
      data:  function() {
        return {
          ...
          directions: [],
          audience:{
            direction: sessionStorage.getItem('administrateur'),
            motif:'',
            date_debut: '',
            date_fin: '',
            time_debut:'',
      ...
      methods: {
        ...
        handleDateSelect(selectInfo) {
          ...
          if(selectInfo.startStr.includes('T') || selectInfo.endStr.includes('T')){
            ...
            this.audience.time_debut = "08:00:00"
            this.audience.time_fin = "16:00:00"
          }
        },
