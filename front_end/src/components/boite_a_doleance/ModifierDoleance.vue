...
<script>
    ...
    export default{
        ...
        // beforeCreate() {
        //     console.log(this.autoritesComputed)
        //     this.setAutorites()
        // },  
       async created() {
    ...
    <div v-if="type_doleance === 'Anonyme'">
        ...
        <div class="type-doleance">
            <form class="row g-3" @submit.prevent="modifier" autocomplete="off">
                ...
                <div class="col-md-4">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" placeholder="Votre nom" v-model="nom">
                ...
                <div class="col-md-4">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="floatingName" placeholder="Votre prénom" v-model="prenom" >
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="email" class="form-control" id="floatingEmail" placeholder="Votre mail" v-model="e_mail">
