...
CREATE TABLE rohiAudience_johns.date_heure_disponible ( 
...
CREATE TABLE rohiAudience_johns.date_heure_disponible_autorite ( 
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
	id_date_heure_disponible INT      ,
	id_autorite          INT      ,
	est_disponible       TINYINT  NOT NULL DEFAULT '1'   ,
	CONSTRAINT fk_date_disponible_autorite_id_date_disponible FOREIGN KEY ( id_date_heure_disponible ) REFERENCES rohiAudience_johns.date_heure_disponible( id ) ON DELETE SET NULL ON UPDATE NO ACTION
 ) ENGINE=InnoDB  DEFAULT CHARSET=latin1;

CREATE TABLE rohiAudience_johns.date_heure_non_disponible_autorite ( 
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
...
CREATE TABLE rohiAudience_johns.demande_audience_autorite ( 
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
...
CREATE TABLE rohiAudience_johns.demande_audience_public ( 
	motif                VARCHAR(200)  NOT NULL    ,
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
	action               INT  NOT NULL DEFAULT '0'   ,
	cin                  VARCHAR(15)      ,
...
CREATE TABLE rohiAudience_johns.dm_aud_autorite_date_heure_dispo ( 
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
	...
	date_debut           DATE      ,
	date_fin             DATE      ,
	CONSTRAINT fk_dm_aud_autorite_date_heure_dispo_id_daa FOREIGN KEY ( id_dm_aud_autorite ) REFERENCES rohiAudience_johns.demande_audience_autorite( id ) ON DELETE CASCADE ON UPDATE NO ACTION,
	CONSTRAINT fk_dm_aud_autorite_date_heure_dispo_id_dh_da FOREIGN KEY ( id_date_heure_disponible_autorite ) REFERENCES rohiAudience_johns.date_heure_disponible_autorite( id ) ON DELETE SET NULL ON UPDATE NO ACTION
 ) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE rohiAudience_johns.dm_aud_public_date_heure_dispo ( 
	id_aud_public        INT      ,
	id_date_heure_disponible_autorite INT      ,
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
	heure_debut          TIME  NOT NULL    ,
	...
	date_debut           DATE      ,
	date_fin             DATE      ,
	CONSTRAINT fk_dm_aud_public_date_heure_dispo FOREIGN KEY ( id_aud_public ) REFERENCES rohiAudience_johns.demande_audience_public( id ) ON DELETE CASCADE ON UPDATE NO ACTION,
	CONSTRAINT fk_dm_aud_public_date_heure_dispo_id_date_heure_disponible FOREIGN KEY ( id_date_heure_disponible_autorite ) REFERENCES rohiAudience_johns.date_heure_disponible_autorite( id ) ON DELETE SET NULL ON UPDATE NO ACTION
 ) ENGINE=InnoDB  DEFAULT CHARSET=latin1;

CREATE TABLE rohiAudience_johns.doleance ( 
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
	session_navigateur   VARCHAR(100)  NOT NULL    ,
	e_mail               VARCHAR(100)      ,
...
CREATE TABLE rohiAudience_johns.domaine ( 
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
	nom_domaine          VARCHAR(30)  NOT NULL    
 ) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

CREATE TABLE rohiAudience_johns.pas_disponible ( 
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
	id_date_heure_disponible_autorite INT  NOT NULL    ,
	id_date_heure_non_disponible_autorite INT  NOT NULL    ,
	CONSTRAINT fk_pas_disponible_id_date_heure_disponible_autorite FOREIGN KEY ( id_date_heure_disponible_autorite ) REFERENCES rohiAudience_johns.date_heure_disponible_autorite( id ) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT fk_pas_disponible_id_date_heure_non_disponible_autorite FOREIGN KEY ( id_date_heure_non_disponible_autorite ) REFERENCES rohiAudience_johns.date_heure_non_disponible_autorite( id ) ON DELETE CASCADE ON UPDATE CASCADE
 ) ENGINE=InnoDB  DEFAULT CHARSET=latin1;

CREATE TABLE rohiAudience_johns.demande_stage ( 
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
	...
	est_termine          TINYINT   DEFAULT '0'   ,
	CONSTRAINT fk_demande_stage_id_domaine FOREIGN KEY ( id_domaine ) REFERENCES rohiAudience_johns.domaine( id ) ON DELETE SET NULL ON UPDATE NO ACTION
 ) ENGINE=InnoDB  DEFAULT CHARSET=latin1;

CREATE TABLE rohiAudience_johns.entretien_demande_stage ( 
	heure_debut          TIME  NOT NULL    ,
	heure_fin            TIME  NOT NULL    ,
	id                   INT  NOT NULL  AUTO_INCREMENT  PRIMARY KEY,
	...
	date_debut           DATE      ,
	date_fin             DATE      ,
	CONSTRAINT fk_entretien_demande_stage_id_date_heure_disponible_autorite FOREIGN KEY ( id_date_heure_disponible_autorite ) REFERENCES rohiAudience_johns.date_heure_disponible_autorite( id ) ON DELETE SET NULL ON UPDATE NO ACTION,
	CONSTRAINT fk_entretien_demande_stage_id_demande_stage FOREIGN KEY ( id_demande_stage ) REFERENCES rohiAudience_johns.demande_stage( id ) ON DELETE SET NULL ON UPDATE NO ACTION
 ) ENGINE=InnoDB  DEFAULT CHARSET=latin1;

CREATE INDEX fk_date_disponible_autorite_id_date_heure_disponible ON rohiAudience_johns.date_heure_disponible_autorite ( id_date_heure_disponible );

CREATE INDEX fk_date_disponible_autorite_id_autorite ON rohiAudience_johns.date_heure_disponible_autorite ( id_autorite );

CREATE INDEX fk_date_heure_non_disponible_autorite_id_autorite ON rohiAudience_johns.date_heure_non_disponible_autorite ( id_autorite );

CREATE INDEX fk_demande_audience_autorite ON rohiAudience_johns.demande_audience_autorite ( id_autorite_enfant_sender );

CREATE INDEX fk_dm_aud_autorite_date_heure_dispo_id_dh_disponible_autorite ON rohiAudience_johns.dm_aud_autorite_date_heure_dispo ( id_date_heure_disponible_autorite );

CREATE INDEX fk_dm_aud_autorite_date_heure_dispo_id_date_heure_dispo ON rohiAudience_johns.dm_aud_autorite_date_heure_dispo ( id_dm_aud_autorite );

CREATE INDEX fk_dm_aud_public_date_heure_dispo_id_date_heure_dispo ON rohiAudience_johns.dm_aud_public_date_heure_dispo ( id_aud_public );

CREATE INDEX fk_dm_aud_public_date_heure_dispo_id_date_heure_dispo_autorite ON rohiAudience_johns.dm_aud_public_date_heure_dispo ( id_date_heure_disponible_autorite );

CREATE INDEX fk_doleance_autorite_enfant ON rohiAudience_johns.doleance ( id_autorite );

CREATE INDEX fk_pas_disponible_id_date_heure_dispo_autorite ON rohiAudience_johns.pas_disponible ( id_date_heure_disponible_autorite );

CREATE INDEX fk_pas_disponible_id_date_heure_non_dispo_autorite ON rohiAudience_johns.pas_disponible ( id_date_heure_non_disponible_autorite );

CREATE INDEX fk_demande_stage_domaine ON rohiAudience_johns.demande_stage ( id_domaine );

CREATE INDEX fk_demande_stage_id_autorite_enfant ON rohiAudience_johns.demande_stage ( id_autorite_enfant );

CREATE INDEX fk_entretien_demande_stage ON rohiAudience_johns.entretien_demande_stage ( id_demande_stage );

CREATE INDEX fk_entretien_demande_stage_id_date_heure_dispo_autorite ON rohiAudience_johns.entretien_demande_stage ( id_date_heure_disponible_autorite );
...
BEGIN
	...
	WHILE @hds < @hfs DO
		set @tmp_hfs = @hds + @das;
		INSERT INTO rohiAudience_johns.date_heure_disponible(date_disponible,heure_debut, heure_fin,duree) VALUES (date_disponible,sec_to_time(@hds),sec_to_time(@tmp_hfs),duree_disponibilite);
		set @hds = @tmp_hfs;
	END WHILE;
END
...
BEGIN
	...
	INSERT INTO rohiAudience_johns.dm_aud_autorite_date_heure_dispo (id_dm_aud_autorite, id_date_heure_disponible_autorite, heure_debut, heure_fin, date_debut, date_fin)
	SELECT 
	@id_aud_autorite,
	dhda.id,
	heure_debut,
	...
	date_fin
	FROM
	rohiAudience_johns.date_heure_disponible_autorite dhda 
	JOIN rohiAudience_johns.date_heure_disponible dhd on dhda.id_date_heure_disponible = dhd.id
	where 
...
BEGIN
	...
	INSERT INTO rohiAudience_johns.dm_aud_public_date_heure_dispo (id_aud_public, id_date_heure_disponible_autorite, heure_debut, heure_fin, date_debut, date_fin)
	SELECT 
	@id_aud_public,
	dhda.id,
	heure_debut,
...
BEGIN 
	...
	-- Ajouter entretien
	INSERT INTO rohiAudience_johns.entretien_demande_stage
...
BEGIN
	...
	IF masque_event_ended IS TRUE THEN
		...
		dap.est_termine,
		true AS editable
		FROM rohiAudience_johns.dm_aud_public_date_heure_dispo dapdhd
...
BEGIN 
	...
	UPDATE rohiAudience_johns.dm_aud_public_date_heure_dispo SET id_date_heure_disponible_autorite = @id_dhda, heure_debut = @heure_debut, heure_fin = @heure_fin, date_debut=@date_audience, date_fin=@date_audience where id = id_dm_aud_public_heure_dispo;
	SELECT 'Votre audience a bien été modifiée' as message;

	UPDATE rohiAudience_johns.demande_audience_public 
...
BEGIN 
	...
	-- Modifier entretien
	UPDATE rohiAudience_johns.entretien_demande_stage 
...
BEGIN 
	...
	IF @id_hda IS NULL THEN
		...
		dhd.heure_debut,
		dhd.heure_fin 
		FROM rohiAudience_johns.date_heure_disponible_autorite dhda 
		join date_heure_disponible dhd on dhda.id_date_heure_disponible = dhd.id 
		LEFT JOIN pas_disponible pd on dhda.id = pd.id_date_heure_disponible_autorite 
		LEFT JOIN dm_aud_autorite_date_heure_dispo daadhd on dhda.id = daadhd.id_date_heure_disponible_autorite 
		LEFT JOIN demande_audience_autorite daa on daa.id = daadhd.id_dm_aud_autorite 
...
BEGIN
	SELECT  
		...
		es.id_demande_stage
    FROM
        rohiAudience_johns.entretien_demande_stage es 
	...
	ELSE 
		...
		UPDATE rohiAudience_johns.demande_stage SET rohiAudience_johns.demande_stage.duree = @duree_final where rohiAudience_johns.demande_stage.id = @id_demande_stage;
	END IF;
END
...
BEGIN
	...
	IF date_debut = date_fin THEN
		IF @nbr_rows = 0 THEN 
			DELETE FROM rohiAudience_johns.dm_aud_autorite_date_heure_dispo where id_dm_aud_autorite = id_audience;
			CALL `ajouter_date_heure_disponible_autorite`(@id_autorite,'08:00:00' , '16:00:00' , date_debut );
		...
		ELSEIF @nbr_rows = 1 THEN
			...
			UPDATE rohiAudience_johns.dm_aud_autorite_date_heure_dispo set id_date_heure_disponible_autorite = @id_date_heure_dispo_autorite, date_debut = date_debut, date_fin = date_fin, heure_debut = heure_debut, heure_fin = heure_fin where id = id_dm_aud_aut_date_heure_dispo;
		ELSEIF @nbr_rows > 1 THEN
			DELETE FROM rohiAudience_johns.dm_aud_autorite_date_heure_dispo where id_dm_aud_autorite = id_audience;
			CALL `ajouter_dm_aud_autorite_date_heure_dispo_entre_deux_date`(id_audience ,date_debut , date_fin , heure_debut ,heure_fin ,@id_autorite );
		END IF;
	ELSEIF date_debut < date_fin THEN
		...
		CALL `ajouter_dm_aud_autorite_date_heure_dispo_entre_deux_date`(id_audience ,date_debut , date_fin , heure_debut ,heure_fin ,@id_autorite );
	END IF;
	UPDATE rohiAudience_johns.demande_audience_autorite set action = 1 where id = id_audience;
END
...
BEGIN
	...
	ELSEIF date_debut < date_fin THEN
		...
		CALL `ajouter_dm_aud_autorite_date_heure_dispo_entre_deux_date`(id_audience ,date_debut , date_fin , heure_debut ,heure_fin ,@id_autorite );
	END IF;
	UPDATE rohiAudience_johns.demande_audience_autorite set action = 2 where id = id_audience;
END
...
BEGIN
	...
	IF date_debut = date_fin THEN
		IF @nbr_rows = 0 THEN 
			DELETE FROM rohiAudience_johns.dm_aud_public_date_heure_dispo where id_aud_public = id_audience;
			CALL `ajouter_date_heure_disponible_autorite`(@id_autorite,'08:00:00' , '16:00:00' , date_debut );
		...
		ELSEIF @nbr_rows = 1 THEN
			...
			UPDATE rohiAudience_johns.dm_aud_public_date_heure_dispo set id_date_heure_disponible_autorite = @id_date_heure_dispo_autorite, date_debut = date_debut, date_fin = date_fin, heure_debut = heure_debut, heure_fin = heure_fin where id = id_dm_aud_public_date_heure_dispo;
		ELSEIF @nbr_rows > 1 THEN
			DELETE FROM rohiAudience_johns.dm_aud_public_date_heure_dispo where id_aud_public = id_audience;
			CALL `ajouter_dm_aud_public_date_heure_dispo_entre_deux_date`(id_audience ,date_debut , date_fin , heure_debut ,heure_fin ,@id_autorite );
		END IF;
	ELSEIF date_debut < date_fin THEN
		...
		CALL `ajouter_dm_aud_public_date_heure_dispo_entre_deux_date`(id_audience ,date_debut , date_fin , heure_debut ,heure_fin ,@id_autorite );
	END IF;
	UPDATE rohiAudience_johns.demande_audience_public set action = 1 where id = id_audience;
END
...
BEGIN
	...
	ELSEIF date_debut < date_fin THEN
		...
		CALL `ajouter_dm_aud_public_date_heure_dispo_entre_deux_date`(id_audience ,date_debut , date_fin , heure_debut ,heure_fin ,@id_autorite );
	END IF;
	UPDATE rohiAudience_johns.demande_audience_public set action = 2 where id = id_audience;
END
...
BEGIN 
	DELETE FROM rohiAudience_johns.demande_audience_autorite where rohiAudience_johns.demande_audience_autorite.id = id;
	DELETE FROM rohiAudience_johns.dm_aud_autorite_date_heure_dispo WHERE rohiAudience_johns.dm_aud_autorite_date_heure_dispo.id_dm_aud_autorite IS NULL;
...
BEGIN 
	DELETE FROM rohiAudience_johns.entretien_demande_stage where entretien_demande_stage.id_demande_stage = id;
	UPDATE rohiAudience_johns.demande_stage SET action = 2 where id = id;
...
BEGIN
	...
	IF @daten <= date2 then
		...
		FROM rohiAudience_johns.date_heure_disponible dhd where dhd.date_disponible = @daten);
